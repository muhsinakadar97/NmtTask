...
import 'package:app_design/src/presentation/widgets/slider_widget.dart';
              ...
              Column(
                    ...
                    child: CustomScrollView(
                      slivers: [
                        const SliverAppBar(
                          ...
                          expandedHeight: 200.0, // Adjusted to match the height of the slider
                          floating: true,
                          flexibleSpace: FlexibleSpaceBar(
                            background: SliderWidget(), // SliderDemo remains unchanged
                          ),
                        ),
                        SliverToBoxAdapter(
                          child: Padding(
               ...
               Positioned(
                    ...
                    child: Container(
                      ...
                      child: Icon(Icons.person, size: 40, color: AppColors.buttonColor.withOpacity(0.15),),
                    ),
                  ),
            ],
          ),
...
//                       automaticallyImplyLeading: false,
//                       expandedHeight:
//                           200.0, // Adjusted to match the height of the slider
//                       floating: true,
//                       flexibleSpace: FlexibleSpaceBar(
//                         background: SliderWidget(), // SliderDemo remains unchanged
//                       ),
