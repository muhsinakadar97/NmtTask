          ...
          slivers: [
              ...
              sliver: SliverList(
                delegate: SliverChildListDelegate(
                  [
                    ...
                    Obx(() {
                      String sectionCountString = (homeController.selectedItemName.value == "Python")
            ...
            SliverList(
              delegate: SliverChildBuilderDelegate(
                (context, index) {
                  String selectedItem = homeController.selectedItemName.value;
                  ...
                  return Column(
                    children: [
                      ...
                      Obx(() {
                        ...
                        courseOverviewController.selectedSectionName.value = sections[index]['sectionName'];
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, chapterIndex) {
                            String chapterName = chapters[chapterIndex]['chapterName'] ?? "Unknown Chapter";
                            String category = chapters[chapterIndex]['category'] ?? "Unknown Status";
                            String chapterNumber = chapters[chapterIndex]['chapterNo'];

                            return Padding(
                              padding: const EdgeInsets.only(bottom: 10, right: 20, left: 20),
                              child: GestureDetector(
                                onTap: () {
                                  String selectedChapterName = chapterName;
                                  ...
                                  Get.to(
                                    () => Video(videoId: chapters[chapterIndex]['video_id']!),
                                    arguments: {
                                      'courseName': homeController.selectedItemName.value,
                                        ...
                                        Text(
                                          ...
                                          style: GoogleFonts.raleway(
                                            ...
                                            color: category == "Locked"
                                                ? Colors.red
                                                : (category == "Premium" ? Colors.orange : Colors.green),
                                          ),
                                        ),
                                      ],
                                    ),
                ...
                childCount: (homeController.selectedItemName.value == "Python")
                    ? courseOverviewController.sectionListPython.length
                    : (homeController.selectedItemName.value == "Flutter")
                        ? courseOverviewController.sectionListFlutter.length
                        : courseOverviewController.sectionListPhp.length,
              ),
            ),
          ],
        ),
