                ...
                SliverList(
                    delegate: SliverChildBuilderDelegate(
                      (context, sectionIndex) {
                        var currentSection = courseOverviewController.sections[sectionIndex];
                          ...
                          children: [
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (context, chapterIndex) {
                                var currentChapter = currentSection.chapters[chapterIndex];

                                String chapterName = currentChapter.chapterName ?? "Unknown Chapter";
                                String category = currentChapter.category ?? "Unknown Status";
                                String chapterNumber = currentChapter.chapterNo ?? "Unknown Number";
                                String videoId = currentChapter.videoId ?? "";
                                String sectionName = currentChapter.sectionName ?? "";
                                ...
                                return Padding(
                                  ...
                                  child: GestureDetector(
                                    onTap: () {
                                      ...
                                      courseOverviewController.selectedChapterName.value = chapterName;
                                      courseOverviewController.selectedSectionName.value = sectionName;
