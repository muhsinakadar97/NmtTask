...
class DoubtsController extends GetxController {
    ...
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        return Container(
          ...
          child: Center(
            child: Text("Your doubt has been submitted. We will check it soon.", style: GoogleFonts.poppins(fontWeight: FontWeight.bold, color: Colors.blueGrey[900]),),
          ),
        );
      },
    );
  ...
  //   doubtText.value = newText;

  //   log("Doubt => ${doubtText.value}");
  // }
