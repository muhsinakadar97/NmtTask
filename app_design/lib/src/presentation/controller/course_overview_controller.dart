...
class CourseOverviewController extends GetxController {
  ...
  // Map<String,String> totalNoOfChaptersPython = {'python' : '21',};
  // Map<String,String> totalNoOfChaptersFlutter = {'flutter' : '22',};
  // Map<String,String> totalNoOfChaptersPhp = {'php' : '11',};
  // Map<String,String> totalNoOfChaptersDjango = {'django' : '0',};
