...
class CourseOverviewController extends GetxController {
  ...
  RxList<Chapter> selectedSectionChapterList = RxList([]);
  ...
  setChapterDetailsOnTap(Section currentSection, int chapterIndex) {
    Chapter currentChapter = currentSection.chapters[chapterIndex];
    log('Chapter : $currentChapter');
    selectedChapterName.value = currentChapter.chapterName;
    selectedSectionName.value = currentChapter.sectionName;
    selectedSection = currentSection;
    selectedChapter = selectedSection.chapters[chapterIndex];
    colorChapterName.value = selectedChapter?.chapterName ?? '';
